...
function Tweet(props) {
  ...
  const handleLike = async (e) => {
    ...
    try {
      ...
      if (location == "/user/home" || location == "/user") {
        const newData = await axios.get(CONST.server + `/tweets/explore`);
  ...
  return (
    <Card sx={{ display:"block",maxWidth: "40vw", width: "600px", padding: "20px", backgroundColor: "#000000", border: "0.5px solid #2F3336" }}
      key={tw._id}
    >
      {show ? <div>
